...
* Add ability to rspec matcher to take array of abilities (gingray) (https://github.com/CanCanCommunity/cancancan/pull/364)
* Reduce unnecessary allocations in Rule creation (timraymond) (https://github.com/CanCanCommunity/cancancan/pull/204)
